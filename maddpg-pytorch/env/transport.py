...
class Transport(GridGame):
    ...
    def observation_space(self):
        return [Box(low=0, high=50, shape=(128,128)) for i in range(self.cars)]
    @property  # 直接掉一个变量 eg. env.observation_space
...
#             # print ("plane_now.look")
        ...
        return self.current_state, self.state_wrapper(self.current_state)

    def state_wrapper(self, s): # from old current state to state update
